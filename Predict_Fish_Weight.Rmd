...
pairs(Fishies)
```
#### Best variables with Perch is Height~Weight.
...
#### Adjusted R-Squared for Perch is 0.9341
...
#### Adjusted R-square for Bream fishes is 0.9346.


```{r}
Smeltmodel=lm(Weight~Length1+Length2+Width,data=Fishies)
summary(Smeltmodel)
```

#### Adjusted R-squared for Smelt is 0.9329.
